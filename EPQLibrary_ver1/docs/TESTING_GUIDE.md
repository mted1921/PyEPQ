...
**`PyEPQ/<Subpkg>/tests/_parity_lib.py`**. Per-file test code imports
from it and contains only file-specific logic. Reference implementation (from the Utility module): `test_parity_math2_ver1_1_3.py`.
...
`jpype.JClass("gov.nist.microanalysis.<Subpkg>.<Class>")`. `setup_parity`
