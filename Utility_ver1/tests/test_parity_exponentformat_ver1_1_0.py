r"""
test_parity_exponentformat_ver1_1_0.py — parity harness for ExponentFormat_ver1_1_0.py
...
from ExponentFormat_ver1_1_0 import ExponentFormat as PyExponentFormat
