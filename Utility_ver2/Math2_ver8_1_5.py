...
try:
    from .FindRoot_ver2_1_0 import FindRoot as _FindRoot
except ImportError:
    try:
        from FindRoot_ver2_1_0 import FindRoot as _FindRoot  # type: ignore
    except ImportError:
        from gov.nist.microanalysis.PyEPQ.Utility.FindRoot_ver2_1_0 import FindRoot as _FindRoot  # type: ignore
