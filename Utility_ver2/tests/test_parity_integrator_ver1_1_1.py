r"""
test_parity_integrator_ver1_1_1.py — parity harness for Integrator
...
-----------------------------------
* Renamed from test_parity_integrator_ver1_1_0.py; added indirect ARK coverage.
...
* CANDIDATE INJECTION: set EPQ_ARK_PORT=/path/to/candidate.py (e.g. an
  ...
  candidate's stepper instead of the canonical AdaptiveRungeKutta_ver2_1_1.
...
responsibility of the AdaptiveRungeKutta parity harness.
...
def _maybe_inject_ark_port() -> str:
    ...
    Integrator resolves its AdaptiveRungeKutta dependency with a bare-name fallback
    (`from AdaptiveRungeKutta_ver2_1_1 import AdaptiveRungeKutta`).  When this
    ...
    sys.modules["AdaptiveRungeKutta_ver2_1_1"] = mod
...
from Integrator_ver2_1_1 import Integrator as PyIntegrator  # noqa: E402
