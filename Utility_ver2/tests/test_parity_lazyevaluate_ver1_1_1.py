r"""
test_parity_lazyevaluate_ver1_1_1.py — parity harness for LazyEvaluate

Revision ver1_1_1 (2026-06-29): updated import to LazyEvaluate_ver1_1_1 (port fix: _compute → compute).
...
from LazyEvaluate_ver2_1_2 import LazyEvaluate as PyLazyEvaluate
