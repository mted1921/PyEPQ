...
- /docs/CONVERSION_GUIDE.md - Instructions for code specification and code conversion.
- /docs/TESTING_GUIDE.md - Instructions for parity harness generation.
- /docs/BUG_GUIDE.md - Instructions for in line bug documentation.
...
### Tools and Scripts
- /tools/check_compliance.py - Unified compliance checking script: Executes 'run_parity.py' (all of the individual parity harnesses), traverses the entire API surface of the Python port while comparing to the Java source API, and updates the `<Class>`_LEDGER.md and BUG_LEDGER.md documents.
